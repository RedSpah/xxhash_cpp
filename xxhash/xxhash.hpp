...
#else
            constexpr static std::array<endianness, 3> endian_lookup = { endianness::littleEndian, endianness::bigEndian, (XXH_CPU_LITTLE_ENDIAN) ? endianness::littleEndian : endianness::bigEndian };
        }
